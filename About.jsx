  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 px-6 md:px-20 py-16">
      ...
      <div className="mt-20 text-center max-w-3xl mx-auto">
        <h3 className="text-3xl font-bold mb-6 text-black-500">Our Mission</h3>
        ...
        <h3 className="text-3xl font-bold mb-6 text-black-500">Our Values</h3>
        <ul className="text-gray-700 text-lg space-y-3 list-disc list-inside text-left">
          <p>🍽️ Fresh, locally-sourced ingredients</p>
          <p>👨‍👩‍👧‍👦 Community-first hospitality</p>
          <p>🌱 Sustainability and mindful cooking</p>
          <p>❤️ Passion, integrity, and culinary creativity</p>
        </ul>
      </div>
    </div>
  );
